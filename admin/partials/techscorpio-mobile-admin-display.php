...
<h1 class="display-4">Techscorpio Mobile</h1>
<p class="lead">This plugin helps your WordPress website to interact with TechScorpio Mobile App</p>
    ...
    <div><br>
      <form method="POST" action="<?php the_permalink() ?>">
        <div class="form-group row">								
          ...
          <div class="col-sm-8">
            <input class="form-control" type="text" name="slider_url" placeholder="http://example.com/image.png"/>
          </div>
  ...
  <div><br>
      <form style="margin:10px;" method="POST" action="<?php the_permalink() ?>">
        <div class="form-group row">								
          ...
          <div class="col-sm-10">
            <input class="form-control" type="text" name="free_content_url" placeholder="http://example.com/video.mp4"/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <input class="form-control" type="text" name="free_content_title" placeholder="Enter Title"/>
          </div>
        </div>
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-10">
            <textarea class="form-control" name="free_content_description" rows="3"></textarea>
          </div>        
        </div>
